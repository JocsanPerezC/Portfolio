  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl text-center">
        ...
        >
          {language === "es"
            ? "Mis perfiles y espacios donde puedes ver más de mi trabajo y contactarme."
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {SOCIALS.map(({ label, href }) => (
            <a
              ...
              rel="noreferrer"
              className={[
                "group rounded-3xl border p-5 text-left backdrop-blur-sm transition duration-300 hover:-translate-y-1 hover:border-[#7c6dfa]/30 hover:bg-[#7c6dfa]/10",
                isDark
